...
#define DASH_Y_START   96      // ⬇ dropped by two lines
...
//--------------------------------------------------
// Execution mode display (STRING ONLY)
//--------------------------------------------------
void Dashboard_UpdateMode(const string text)
{
   ObjectSetString(0,D_MODE,OBJPROP_TEXT,"Mode: "+text);
}
